...
public class LoginStepDefs {
	...
	public LoginStepDefs(RequestFactory requestFactory, DriverFactory driverFactory) {
...
//	@Step("^An \"([^\"]*)\" is logged in the system$")
	@Step @Given("^An \"([^\"]*)\" is logged in the system$")
...
//	@Step("^User completes Email field with \"([^\"]*)\" credentials$")
	@Step @When("^User completes Email field with \"([^\"]*)\" credentials$")
...
//	@Step("^User completes Email field with any credentials$")
	@Step @When("^User completes Email field with any credentials \"([^\"]*)\"$")
...
//	@Step("^User completes Password field with \"([^\"]*)\" credentials$")
	@Step @And("^User completes Password field with \"([^\"]*)\" credentials$")
...
//	@Step("^User completes Password field with any credentials \"([^\"]*)\"$")
	@Step @And("^User completes Password field with any credentials \"([^\"]*)\"$")
...
//	@Step("Login page is displayed")
	@Step @Given("^Login page is displayed$")
...
//	@Step("^the Toast message is Displayed$")
	@Step @And("^the Toast message is Displayed$")
...
//	@Step("Login failed with wrong credentials")
	@Step @When("Login failed with wrong credentials")
